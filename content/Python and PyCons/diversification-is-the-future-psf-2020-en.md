...
directors fulfilling their term. After many years [working with and building the community on this side of the planet]({filename}/Python and PyCons/changing-the-world-via-pycon-en.md)
...
The PSF should approach advocating about what it does like what tech companies do now days when they are hiring: By stressing the impact of
and influence its work on how their customers live their lives.
...
this regard, the board of the PSF plays and important role to advocate and
market its role.
...
What costs were involved to get generate those revenue? If these are recurring
...
breeds goodwill, trust and paves way for a stronger relationship.
...
inidividual membership fees that we can expect to get from that region. Again,
in order for us to do that, we need a wider base of supporters on the ground
from that region to make it work.

There are many succesfull local companies in each region and country that directly or indrectly
