...
2019年以降、私は東アジア、南アジア、東南アジア（まとめてアジア太平洋と呼ばれる）にあるPythonコミュニティがより一貫した方向に進めるよう尽力してきた。
またピッツバーグで毎年開催されるPyCon 2020の期間中に、より広範な北米および国際コミュニティに紹介するポスターセッションも予定されていたが、
COVID-19のため残念ながら中止になった。
PyCon US[^fn01] とはPythonソフトウェア財団（PSF）が主催する年に1度のプログラミング言語Pythonに関するカンファレンスで、同時に唯一の大規模な資金調達イベントでもある。

# Pythonソフトウェア財団（PSF）とは

まず、次のことを認めざるを得ない。2002年にPythonを使い始めたとき、PSFの存在については知らなかった。
...
長年、[地球の裏側でコミュニティを構築するために働きながら]({filename}/Python and PyCons/changing-the-world-via-pycon-en.md)
...
短期的には資金調達の努力を多様化するために多くの仕事が行われている、と回答した。長期的には、多くの取り組みは目標に焦点を当て、
...
PSF理事会はこの言語とそれに依存する人々の将来を向上させるために資源を使用する広い責任があり、
...
その時点においてPSFは、米国のPyConに参加している大半が友達同士の白人たちで構成された、遠く離れた米国の助成金も出す組織だ。
...
PSFは[会員制をオープンする](http://pyfound.blogspot.com/2015/02/enroll-as-psf-voting-member.html)にあたり、実に大きな前進だった。
...
あるいは[Naomi](https://twitter.com/naomiceder)が帰った後もずっとPSFについて語り続けられる人物がいれば、
そのほうがずっと良いだろう。
...
より良い関係を築くために、次はPSFへ直接資金援助してくれる支援メンバーのグループ拡大に尽力すべきだ。
...
具体的に理事会として１つ考えられる目標としては、特定の地域に与えられた助成金の割合を、
その地域から得られる企業のスポンサーシップや個人の会費のこと。
